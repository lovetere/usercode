...
class HelixParNBins : private HelixParBinId
{
  public:
    ...
    unsigned int  nEta  ( )  const              { return HelixParBinId::nCurv()+1; }
    unsigned int  nLip  ( )  const              { return HelixParBinId::nCurv()+1; }
    unsigned int  nPhi  ( )  const              { return HelixParBinId::nCurv()+1; }
    unsigned int  nTip  ( )  const              { return HelixParBinId::nCurv()+1; }
